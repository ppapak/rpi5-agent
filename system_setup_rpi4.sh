...
set_config "dtoverlay=googlevoicehat-soundcard" ""
set_config "gpu_mem" "256"
set_config "dtoverlay=ov5647" ""
set_config "dtoverlay=dwc2,dr_mode=peripheral" ""
...
echo "3. To adjust volume: alsamixer -c sndrpigooglevoi"
echo "----------------------------------------------------"